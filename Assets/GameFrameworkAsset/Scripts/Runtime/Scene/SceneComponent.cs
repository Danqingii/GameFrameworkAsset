...
namespace UnityGameFramework.Runtime
{
    ...
    [AddComponentMenu("GameFramework Asset/Scene")]
    public sealed class SceneComponent : GameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            {
                Debug.LogError("Scene manager is invalid.");
                return;
            }
            ...
            {
                Debug.LogError("Game Framework scene is invalid.");
                return;
            }
        }
        ...
        public void SetSceneOrder(string sceneAssetName, int sceneOrder)
        {
            ...
            Debug.LogError("Scene '{sceneAssetName}' is not loaded or loading.");
        }
        ...
        private void RefreshSceneOrder()
        {
            if (m_SceneOrder.Count > 0)
            {
                ...
                if (!scene.IsValid())
                {
                    Debug.LogError($"Active scene '{maxSceneName}' is invalid.");
                    return;
                }
        ...
        {
            Debug.LogError("Load scene failure, scene asset name '{e.SceneAssetName}', error message '{e.ErrorMessage}'.");
        ...
        {
            Debug.LogError($"Unload scene failure, scene asset name '{e.SceneAssetName}'.");
