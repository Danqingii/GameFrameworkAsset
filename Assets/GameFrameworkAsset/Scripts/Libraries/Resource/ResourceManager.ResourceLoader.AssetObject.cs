            ...
            private sealed class AssetObject : ObjectBase
            {
                ...
                protected internal override void Release(bool isShutdown)
                {
                    if (!isShutdown)
                    {
                        ...
                        {
                            throw new GameFrameworkException($"Asset target '{Name}' reference count is '{1}' larger than targetReferenceCount.");
                        }
                        ...
                        foreach (object dependencyAsset in m_DependencyAssets)
                        {
                            ...
                            {
                                throw new GameFrameworkException($"Asset target '{Name}' dependency asset reference count is invalid.");
                            }
                        }
