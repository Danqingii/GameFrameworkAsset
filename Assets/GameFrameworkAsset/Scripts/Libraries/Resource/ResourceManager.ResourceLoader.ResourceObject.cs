            ...
            private sealed class ResourceObject : ObjectBase
            {
                ...
                protected internal override void Release(bool isShutdown)
                {
                    if (!isShutdown)
                    {
                        ...
                        {
                            throw new GameFrameworkException($"Resource target '{Name}' reference count is '{targetReferenceCount}' larger than 0.");
                        }
                        ...
                        foreach (object dependencyResource in m_DependencyResources)
                        {
                            ...
                            {
                                throw new GameFrameworkException($"Resource target '{Name}' dependency asset reference count is invalid.");
                            }
                        }
                    }
