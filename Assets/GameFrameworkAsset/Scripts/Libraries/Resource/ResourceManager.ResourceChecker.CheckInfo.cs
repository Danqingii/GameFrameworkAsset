    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        private sealed partial class ResourceChecker
        {
            ...
            private sealed partial class CheckInfo
            {
                ...
                private LocalVersionInfo m_ReadOnlyInfo;   //本地只读资源信息
                private LocalVersionInfo m_ReadWriteInfo;  //本地可读写资源信息
                ...
                public void SetVersionInfo(LoadType loadType, int length, int hashCode, int compressedLength, int compressedHashCode)
                {
                    ...
                    {
                        throw new GameFrameworkException($"You must set version info of '{m_ResourceName.FullName}' only once.");
                    }
                ...
                public void SetReadOnlyInfo(LoadType loadType, int length, int hashCode)
                {
                    ...
                    {
                        throw new GameFrameworkException($"You must set read-only info of '{m_ResourceName.FullName}' only once.");
                    }
                ...
                public void SetReadWriteInfo(LoadType loadType, int length, int hashCode)
                {
                    ...
                    {
                        throw new GameFrameworkException($"You must set read-write info of '{m_ResourceName.FullName}' only once.");
                    }
